...
ALLOWED_HOSTS = ['.helloworld.co.ke', '.localhost']

CORS_ORIGIN_REGEX_WHITELIST = (
    '^(https?://)?(\w+\.)?localhost\:8030$',
    '^(https?://)?(.+)-?.helloworld.co.ke$',
)
...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'oauth2_provider',
    'helloworld.blog.apps.BlogConfig',
    'helloworld.common.apps.CommonConfig',
    'helloworld.user.apps.UserConfig'
]
...
WSGI_APPLICATION = 'helloworld.config.wsgi.application'

# Database
# https://docs.djangoproject.com/en/1.8/ref/settings/#databases

DATABASES = {'default': dj_database_url.config(env='HELLO_WORLD_DB')}
